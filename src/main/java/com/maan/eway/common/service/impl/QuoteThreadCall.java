...
//							}
		...
		//	Double taxPremium = taxCovers.stream().filter( o -> o.getDiscLoadId().equals(0) && o.getCoverageType().equals("T") ).mapToDouble( o ->   o.getTaxAmount().doubleValue()  ).sum();
			...
			List<PolicyCoverData>  taxCoversFilter =  covers2.stream().filter(o -> o.getTaxId()!=0  ).filter(  distinctByKey(o -> Arrays.asList(o.getVehicleId() ,o.getSectionId(),o.getCoverId() )) ).collect(Collectors.toList());
