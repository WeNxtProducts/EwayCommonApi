...
import com.maan.eway.bean.EserviceInsuredDetailsId;

@Transactional
public interface EserviceInsuredDetailsRepository  extends JpaRepository<EserviceInsuredDetails,EserviceInsuredDetailsId > , JpaSpecificationExecutor<EserviceInsuredDetails> {

	EserviceInsuredDetails findByCustomerReferenceNo(String requestReferenceNo);
...
//
	List<EserviceInsuredDetails>  findByInsuredReferenceNoOrderByEntryDateDesc(String insuredReferenceNo);
//
