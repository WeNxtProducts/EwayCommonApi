...
public interface FactorRateRequestDetailsRepository  extends JpaRepository<FactorRateRequestDetails,FactorRateRequestDetailsId > , JpaSpecificationExecutor<FactorRateRequestDetails> {
	...
	void deleteByRequestReferenceNoAndVehicleIdAndCompanyIdAndProductIdAndSectionIdAndLocationIdAndCoverIdIn(
			String requestReferenceNo, Integer valueOf, String insuranceId, Integer valueOf2, Integer valueOf3,
			Integer valueOf4, List<Integer> coverIdList);
	...
	List<FactorRateRequestDetails> findByRequestReferenceNoAndSectionIdInAndLocationIdInOrderByVehicleIdAsc(
			String requestReferenceNo, List<String> sectionid, List<Integer> locationid);

	List<FactorRateRequestDetails> findByRequestReferenceNoAndSectionIdNotAndLocationId(String requestReferenceNo,
			int i, Integer locationId);

	List<FactorRateRequestDetails> findByRequestReferenceNoAndLocationIdAndVehicleIdAndProductIdAndSectionIdOrderByCoverIdAsc(
			String requestReferenceNo, Integer valueOf, Integer valueOf2, Integer valueOf3, Integer valueOf4);

	List<FactorRateRequestDetails> findByRequestReferenceNoAndLocationIdAndVehicleIdAndProductIdAndSectionIdAndCoverId(
			String requestReferenceNo, Integer valueOf, Integer valueOf2, Integer valueOf3, Integer valueOf4,
			Integer valueOf5);
