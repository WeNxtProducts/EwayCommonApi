...
public interface SeqPiftTranIdRepository  extends JpaRepository<SeqPiftTranId,Long > , JpaSpecificationExecutor<SeqPiftTranId> {


	List<SeqPiftTranId> findAllByOrderByTranIdDesc();
