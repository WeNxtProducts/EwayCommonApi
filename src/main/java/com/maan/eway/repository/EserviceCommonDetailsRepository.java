...
public interface EserviceCommonDetailsRepository  extends JpaRepository<EserviceCommonDetails,EserviceCommonDetailsId > , JpaSpecificationExecutor<EserviceCommonDetails> {
	...
	List<EserviceCommonDetails> findByPolicyNoAndRiskId(String prevPolicyNo, int i);
		...
		List<EserviceCommonDetails> findByRequestReferenceNoAndLocationIdAndSectionId(String requestReferenceNo,
				Integer locationId, String sectionId);

		List<EserviceCommonDetails> findByRequestReferenceNoAndLocationIdInAndSectionIdInAndRiskIdInAndCoverIdIn(
				String requestReferenceNo, List<Integer> locationid, List<String> sectionid, List<Integer> riskIDs,
				List<Integer> coverid);

		List<EserviceCommonDetails> findByRequestReferenceNoAndSectionIdAndLocationId(String requestReferenceNo,
				String sectionId, Integer locationId);

		List<EserviceCommonDetails> findByRequestReferenceNoAndLocationIdInAndSectionIdInAndRiskIdIn(
				String requestReferenceNo, List<Integer> locationid, List<String> sectionid, List<Integer> riskIDs);
