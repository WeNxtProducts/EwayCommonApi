...
/**
* Domain class for entity "PolicyCoverDataEndt"
*
...
@DynamicUpdate
@Builder
@IdClass(PolicyCoverDataEndtId.class)
@Table(name="policy_cover_data_endt")


public class PolicyCoverDataEndt implements Serializable {
